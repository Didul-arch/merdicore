...
import { NEWS_DATA, PRODUCTS_DATA } from '@/lib/data';
import { NewsItem, ProductItem } from '@/lib/types';
...
export default function Page() {
  ...
  return (
    <div className="space-y-0">
      ...
      {/* Quick Access Grid / Services */}
      <section className="py-12 bg-white relative -mt-6 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-50 p-6 rounded-2xl border border-gray-100 flex items-start space-x-4 shadow-sm hover:shadow-md transition-all">
              <div className="p-3 bg-teal-100 text-teal-800 rounded-xl">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <div>
                <h4 className="font-bold text-gray-900 text-sm sm:text-base mb-1">Pelayanan Transparan</h4>
                <p className="text-xs text-gray-500 font-light leading-relaxed">
                  Semua informasi regulasi, anggaran, dan dokumen desa dapat diakses secara terbuka oleh seluruh warga.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-gray-100 flex items-start space-x-4 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                <h4 className="font-bold text-gray-900 text-sm sm:text-base mb-1">UMKM Unggulan Lokal</h4>
                <p className="text-xs text-gray-500 font-light leading-relaxed">
                  Kami membina puluhan usaha warga agar terus berinovasi dan merambah pasar regional maupun nasional.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-gray-100 flex items-start space-x-4 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                <h4 className="font-bold text-gray-900 text-sm sm:text-base mb-1">Hubungan Warga Cepat</h4>
                <p className="text-xs text-gray-500 font-light leading-relaxed">
                  Saluran komunikasi langsung dengan kantor desa untuk menyampaikan aspirasi atau aduan pelayanan.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 space-y-4 sm:space-y-0">
            ...
            <div>
              <button
                ...
                className="inline-flex items-center space-x-1.5 bg-[#0f172a] hover:bg-[#1e293b] text-white px-5 py-3 rounded-xl text-xs sm:text-sm font-bold transition-all cursor-pointer shadow-sm"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {latestNews.map((item) => (
              <article
                ...
                className="bg-slate-50 rounded-2xl overflow-hidden border border-gray-150 hover:border-teal-500/30 hover:shadow-xl transition-all duration-300 cursor-pointer group flex flex-col h-full"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 space-y-4 sm:space-y-0">
            ...
            <div>
              <button
                onClick={() => router.push('/umkm')}
                className="inline-flex items-center space-x-1.5 bg-[#0f766e] hover:bg-[#0d5f58] text-white px-5 py-3 rounded-xl text-xs sm:text-sm font-bold transition-all cursor-pointer shadow-sm"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProducts.map((product) => (
              <div
                key={product.id}
                className="bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-teal-500/20 hover:shadow-xl transition-all duration-300 flex flex-col h-full group"
              >
                ...
                <div className="p-6 flex flex-col flex-grow space-y-4">
                  ...
                  <button
                    ...
                    className="w-full border border-teal-600 hover:bg-teal-50 text-teal-700 hover:text-teal-800 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center justify-center space-x-2 cursor-pointer"
                  >
